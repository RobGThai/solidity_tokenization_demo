...
class App extends Component {
  ...
  updateTotalSupply = async () => {
    let supply = await this.tokenInstance.methods.balanceOf(this.tokenInstance).call();
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <p>Total Supply: {this.state.totalSupply} CAPPU Tokens</p>
